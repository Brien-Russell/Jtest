  ...
  <div class="container p-2">
    <div class="grid content-center mx-auto">
      <div class="lg:mb-2 mb-6">
        <a href="https://www.systbio.org/" >
        <img
          alt="SSBlogo"
          src="/images/SSBlogo.svg"
          class="object-scale-down h-16 w-16 mx-auto rounded-lg hover:scale-150"
        />
        </a>
      </div>
 ...
 Development of the Phyleaux Javascript Library and related interactive phylogenetics tools is supported by the Society of Systematic Biologists.
  ...
  <div class="container pt-9">
    <div class="flex justify-center mb-9">
      ...
      <a href="https://twitter.com/jembrown" class="mr-9 text-gray-800 hover:scale-150">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a href="https://github.com/jembrown" class="text-gray-800 hover:scale-150">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
